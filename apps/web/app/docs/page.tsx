      ...
      <div className="max-w-md w-full text-center relative z-10 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-on-surface-variant leading-relaxed">
            The documentation and support portal is currently being finalized. All core defect workflows, RBAC testing, and graph analytics are live in the app.
          </p>
        </div>
